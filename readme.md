...
## v4.3.0 - [September 18, 2025]

- Added: New Roles and Capabilities for interacting with the Block Editor
- Chore: Updated packages
- Tweak: Removed extra spacing on list elements (`ol` and `ul`)
- Tweak: Swapped hard-coded values in theme.json to use presets
- Tweak: Added further base styles to different blocks to match Bootstrap's
- Tweak: Preferred WP-generated CSS Custom Properties and added fallbacks from SCSS bundle where able

## v4.2.0 - [August 29, 2025]

- Added: Fluid type utils in scss are added!
- Tweak: Configs now properly handle `.../bootstrap.scss` and `webpack.config.js` files without throwing errors
- Tweak: Private scss mixins/functions are allowed

## v4.1.2

-   Tweak: Repo now comes with lint rules configured.

## v4.1.1

-   Fixed: Added the `gill-sans-nova` font name back into the font declaration in `theme.json`
-   Tweak: Updated Github CI/CD to use new shared workflow

## v4.1.0

-   Added: Theme handles fluid type better
-   Added: Theme now supports MediaPress out of the box
-   Fixed: Block editor has first-class style definitions
